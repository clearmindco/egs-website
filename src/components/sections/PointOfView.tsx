        ...
        <ScrollReveal>
          ...
          <div className="mt-6 border-l-2 border-electric-blue pl-6 sm:pl-10">
            <h2 className="font-display text-3xl font-bold leading-[1.1] tracking-tight text-white sm:text-4xl lg:text-6xl">
              <span className="text-electric-blue">Better Systems</span>{" "}
        ...
        <ScrollReveal delayMs={120} className="mt-12">
          <div className="grid gap-10 lg:grid-cols-12 lg:gap-8">
            <p className="font-sans text-lg leading-relaxed text-cool-gray lg:col-span-6 lg:col-start-1">
              ...
              — they have a systems problem. A new ad campaign can&apos;t fix
              a slow follow-up process. A better website can&apos;t fix
            ...
            <p className="font-sans text-lg leading-relaxed text-cool-gray lg:col-span-5 lg:col-start-8">
              EGS takes a different approach. We diagnose the connected
              system behind your growth — from how you&apos;re found, to how
              you earn trust, to how you win and keep the job — and improve
              it as one working system, not a list of disconnected services.
              That thinking is what the EGS Growth Engine™ is built on.
            </p>
          </div>
        </ScrollReveal>
      </Container>
